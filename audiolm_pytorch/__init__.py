...
from audiolm_pytorch.soundstream import SoundStream, FrameStreamingSoundStream, AudioLMSoundStream, MusicLMSoundStream
...
try:
    ...
    # fairseq is only needed by AudioLM's semantic-token components, not by
    # SoundStream codec training or inference.
    if exc.name != "fairseq":
        raise
